...
- **Visual Feedback**: Grid button shows a green border when active (no green fill; inactive stays gray)
...
- Grid button shows visual state (green border only when grid is visible)
...
### Update (Latest): Symbol Display and Search
