  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        {/* Suggested Pairs - responsive design with overflow handling */}
          ...
          <div className="mb-2">
            <div className="flex items-center gap-0.5 overflow-hidden">
              ...
              {analysis.suggestedPairs.length > 5 && (
                <span className="text-blue-600 dark:text-blue-400 font-bold text-sm sm:text-base ml-0.5 flex-shrink-0">...</span>
              )}
            </div>
          </div>
        )}
