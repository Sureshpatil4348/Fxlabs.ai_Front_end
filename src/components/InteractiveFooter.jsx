      ...
      <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-2xl font-bold font-poppins">FX<span className="text-gray-600 dark:text-gray-400">LABS</span></div>
                  <div className="text-gray-600 dark:text-gray-400 text-sm">Decode the Market</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-8">
              {/* Product Links */}
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-6 font-poppins">Product</h3>
                <ul className="space-y-3">
                  {footerLinks.product.map((link, index) => (
                    <li key={index}>
                      <Link 
                        to={link.href}
                        className="text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200 text-sm flex items-center group"
                      >
              ...
              {/* Company Links */}
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-6 font-poppins">Company</h3>
                <ul className="space-y-3">
                  {footerLinks.company.map((link, index) => (
                    <li key={index}>
                      <Link 
                        to={link.href}
                        className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 text-sm flex items-center group"
                      >
                        <ArrowRight className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                        {link.name}
                      </Link>
              ...
              {/* Support Links */}
              <div>
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-6 font-poppins">Support</h3>
                <ul className="space-y-3">
                ...
                <ul className="space-y-3">
                  {footerLinks.legal.map((link, index) => (
                    <li key={index}>
                      <Link 
                        to={link.href}
                        className="text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-200 text-sm flex items-center group"
                      >
                        <ArrowRight className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                        {link.name}
                      </Link>
        ...
        <div className="border-t border-gray-300 dark:border-gray-600/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800/80 dark:to-gray-900/80 rounded-2xl p-8 border border-gray-300 dark:border-gray-600/50 transition-colors duration-300">
                  ...
                  <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
                        required
                      />
                    </div>
                    <button
