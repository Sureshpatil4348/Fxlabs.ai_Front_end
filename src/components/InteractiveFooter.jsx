...
const InteractiveFooter = () => {
  ...
  return (
    <footer className={`relative py-8 sm:py-12 w-full ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>
      <div className="w-full px-4 sm:px-6 lg:px-8">
        
        {/* Forex Ticker Tape */}
        <div className="ticker-tape border-y border-gray-200 dark:border-[#19235d] py-2 md:py-3 overflow-hidden w-full transition-colors duration-300 mb-8">
          <div className="ticker-content flex items-center animate-scroll">
            ...
            <div className="ticker-item flex items-center mx-2 md:mx-6" data-pair="EURUSD">
              ...
              <div className="flex items-center text-sm md:text-base">
                <span className="font-semibold mr-1 md:mr-2 text-[#19235d] dark:text-white transition-colors duration-300">EUR/USD</span>
            ...
            <div className="ticker-item flex items-center mx-2 md:mx-6" data-pair="GBPUSD">
              ...
              <div className="flex items-center text-sm md:text-base">
                <span className="font-semibold mr-1 md:mr-2 text-[#19235d] dark:text-white transition-colors duration-300">GBP/USD</span>
                <span className="ask-value text-green-600 dark:text-green-400 transition-colors duration-300">
            ...
            <div className="ticker-item flex items-center mx-2 md:mx-6" data-pair="USDJPY">
              ...
              <div className="flex items-center text-sm md:text-base">
                <span className="font-semibold mr-1 md:mr-2 text-[#19235d] dark:text-white transition-colors duration-300">USD/JPY</span>
                <span className="ask-value text-green-600 dark:text-green-400 transition-colors duration-300">
            ...
            <div className="ticker-item flex items-center mx-2 md:mx-6" data-pair="USDCHF">
              ...
              <div className="flex items-center text-sm md:text-base">
                <span className="font-semibold mr-1 md:mr-2 text-[#19235d] dark:text-white transition-colors duration-300">USD/CHF</span>
                <span className="ask-value text-green-600 dark:text-green-400 transition-colors duration-300">
            ...
            <div className="ticker-item flex items-center mx-2 md:mx-6" data-pair="XAUUSD">
              ...
              <div className="flex items-center text-sm md:text-base">
                <span className="font-semibold mr-1 md:mr-2 text-[#19235d] dark:text-white transition-colors duration-300">XAU/USD</span>
                <span className="ask-value text-green-600 dark:text-green-400 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <h3 className={`text-lg font-bold ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>
              FxLabs Prime
            </h3>
            ...
            <div className="flex items-center flex-wrap gap-3 pt-2">
              <a 
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
                    ? 'bg-[#19235d] text-gray-300 hover:text-white hover:bg-[#19235d]' 
              ...
              <a 
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
                    ? 'bg-[#19235d] hover:bg-pink-600 text-gray-300 hover:text-white' 
              ...
              <a 
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
                    ? 'bg-[#19235d] hover:bg-blue-700 text-gray-300 hover:text-white' 
              ...
              <a 
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
                    ? 'bg-[#19235d] hover:bg-red-600 text-gray-300 hover:text-white' 
              ...
              <a 
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
                    ? 'bg-[#19235d] hover:bg-blue-500 text-gray-300 hover:text-white' 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className={`text-sm transition-colors duration-200 ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-600 hover:text-[#19235d]'}`}
                >
                  @Fxlabs_prime
                </a>
              </div>
        ...
        {/* Divider Line */}
        <div className={`border-t mb-6 ${isDarkMode ? 'border-[#19235d]' : 'border-gray-300'}`}></div>
