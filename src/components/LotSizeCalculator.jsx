            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <div className="relative group flex-1">
                  ...
                  />
                  <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-medium">{instrumentConfigs[formData.instrumentType].stopLossUnit}</span>
                </div>
              </div>
              {errors.stopLoss && (
