        ...
        <div className="p-4 space-y-4">
          {loading ? (
            ...
            <>
              ...
              <div>
                <label htmlFor="heatmap-tracker-mode" className="block text-xs font-medium text-gray-700 dark:text-slate-300 mb-1">Mode</label>
                <select
              ...
              <div className="flex items-center justify-between">
                <div className="text-xs text-gray-500 dark:text-slate-400">Triggers when Buy% or Sell% crosses threshold.</div>
                <div className="flex items-center space-x-2">
                  {alert && (
