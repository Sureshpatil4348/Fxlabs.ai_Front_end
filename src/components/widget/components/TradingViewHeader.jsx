...
export const TradingViewHeader = () => {
  ...
  return (
    ...
    <SymbolSearchModal
      ...
      {/* New minimal Indicators panel (RSI Enhanced + EMA Touch) */}
        ...
        >
          <div className="p-3">
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-600">Active Indicators:</span>
                <span className="font-bold text-blue-600">{Object.values(settings.indicators).filter(Boolean).length} / 2</span>
              </div>
            </div>
          </div>
        </div>,
