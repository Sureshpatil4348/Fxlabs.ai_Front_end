...
export const TradingViewHeader = () => {
  ...
  return (
    ...
    <SymbolSearchModal
      ...
      {/* New minimal Indicators panel (RSI Enhanced + EMA Touch + ATR Enhanced + BB Pro + MA Enhanced + ORB Enhanced + ST Enhanced) */}
        ...
        >
          <div className="p-3">
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              <div className="flex items-center justify-between text-xs">
                <span className="text-gray-600">Active Indicators:</span>
                <span className="font-bold text-blue-600">{Object.values(settings.indicators).filter(Boolean).length} / 7</span>
              </div>
            </div>
          </div>
        </div>,
