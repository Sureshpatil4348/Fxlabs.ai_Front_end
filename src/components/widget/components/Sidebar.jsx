                ...
                <div className="space-y-1">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Trend Line</p>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Horizontal Line</p>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Fibonacci</p>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Rectangle</p>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Text</p>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="text-left flex-1">
                        <p className="text-[13px] font-semibold text-gray-900 leading-tight">Arrow</p>
                  ...
                  <div className="border-t border-gray-200 pt-1.5 mt-1.5">
                    ...
                    >
                      <div className="flex items-center justify-center space-x-1.5">
                        ...
                        <span className="text-[13px] font-semibold">Clear All</span>
                      </div>
                    </button>
                  </div>
                </div>
