      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`prose prose-lg max-w-none ${isDarkMode ? 'prose-invert' : ''}`}>
          ...
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>1) General Principle</h2>
          ...
          {/* 2. Free Trials */}
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>2) Free Trials / IB Promotions</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
          ...
          {/* 3. Auto-Renewals */}
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>3) Auto-Renewals & Cancellations</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
          ...
          {/* 4. Billing Currency */}
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>4) Billing Currency, Taxes & Price Changes</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
          ...
          {/* 5. Duplicate Charges */}
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>5) Duplicate Charges / Fraudulent Use</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
          ...
          {/* 6. Chargebacks */}
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>6) Chargebacks</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
          ...
          <section className="mb-8">
            <h2 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-[#19235d]'}`}>7) Service Availability</h2>
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
